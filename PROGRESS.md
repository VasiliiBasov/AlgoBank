...
**Текущий шаг:** 6 / 26 (DTO + валидация — **в работе**: 6A ✅ 92/100, 6B ✅ 90/100 (зачёт 70 → ротация), задача easy палиндром IBAN ✅ 93/100; далее Luhn (medium) + 6C springdoc)
...
**Далее по 6:** задача easy ✅ палиндром IBAN (93/100; баг `hi-lo` — урок пограничных индексов) → **Luhn (medium) с JUnit**, затем 6C (springdoc OpenAPI).
