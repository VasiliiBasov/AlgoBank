...
- **Шаг:** 5 / 26 (Spring Boot REST basics — **в работе:** 5A/5B/5C ✅, задачи ✅ (FizzBuzz 90, BankGreeter 95, первые JUnit-тесты), артефакты ⏳: README, CI, ASCII-схема, тег step-05; шаг 4 ✅ 17.09.2026)
