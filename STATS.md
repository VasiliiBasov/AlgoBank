...
**Текущий шаг:** 5 / 26 — Spring Boot REST basics (в работе: 5A/5B/5C ✅, задачи ✅, остались артефакты)

**Последнее обновление:** 19.09.2026, ночь (шаг 5: 5C ✅ — пирамида конфигурации разобрана и подтверждена практикой; задачи FizzBuzz 90 + BankGreeter 95 с первыми JUnit 5 тестами 4/4 + 4/4 ✅; остались артефакты: README, CI, ASCII-схема, тег step-05)
...
| 25 | 19.09.2026 | Шаг 5: разминка-квиз на старте (record pattern 75/100 ✅, далее вопросы 2-3) + артефакты шага (README/ASCII-схема/CI/тег step-05). Старт 10:26, **пауза 11:00 → 13:30 (2.5 ч, проставлена задним числом)** | ⏳ |
...
**ИТОГО по всем сессиям:** **19.7 ч** за 8 дней (11.09 — 19.09.2026) — 15.9 ч по факту + 1.8 ч ночная 17.09 (git-окно, см. *) + 2.0 ч ночная 19.09 (**)
...
- Шаг 5 (в работе): 2.0 ч (5C: пирамида конфигурации + практика + FizzBuzz/BankGreeter с первыми JUnit 5 тестами)
