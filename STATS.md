...
| 22 | 17.09.2026 | Шаг 4 ретест-разминка (3 вопроса) — **38/60**; record pattern в ротации повторения | н/д* |
| 23 | 17.09.2026 | Шаг 5A/5B: SecurityConfig (первая 401 → permitAll), `/api/hello` JSON, H2-консоль — двойной баг (лямбда-пустышка + Boot 4 модуль `spring-boot-h2console`) | н/д* |

\* Сессия 17.09 (ночь): время не зафиксировано — стартовая точка сессии утеряна с контекстом; по git-коммитам рабочее окно ≥ 00:42 → ~02:30 (≥1.6 ч). В ИТОГО не включено.

**ИТОГО по всем сессиям:** **15.9 ч** за 7 дней (11.09 — 17.09.2026) + сессия 17.09 (ночь, время н/з — см. примечание *)
