...
| 3 | **AlgoBank** | **Java Core повт. + Spring Boot + Алгоритмы + SQL** | ⏳ В процессе | **6 / 26** (шаги 0-6 завершены; **шаг 6 ✅ 88.9/100**: 6A 92 / 6B 90 / 6C 90, задачи IBAN 93 + Luhn 92, зачёты 80; тег `step-06`; далее шаг 7 JPA + Docker) | **26.7+** (старт 11.09.2026, идёт; день 21.09 не закрыт) | **88%** (Ш1-5: 85 / 89.6 / 89.5 / 89.0 / 88.9-по-5C-65; Ш6: 88.9) | `AlgoBank/COURSE_HANDBOOK.md` |
...
| AlgoBank | 11.09.2026 → _TBD_ | 26.7 (в процессе) |
