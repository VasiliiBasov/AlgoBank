...
| 3 | **AlgoBank** | **Java Core повт. + Spring Boot + Алгоритмы + SQL** | ⏳ В процессе | **5 / 26** (шаги 0-5 завершены, **шаг 6 в работе: 6A ✅ 92 + 6B ✅ 90 (зачёт 70→рот.) + задача easy ✅ 93**, далее Luhn + 6C) | **26.7** (старт 11.09.2026, идёт) | **88%** (Ш1-4: 85 / 89.6 / 89.5 / 89.0; Ш5 артефактный: 5C-экзамены 65, задачи 92.5; Ш6: 6A 92 / 6B 90 / задача-easy 93) | `AlgoBank/COURSE_HANDBOOK.md` |
...
| Пройти AlgoBank | _TBD_ | ⏳ шаг 6/26 в работе (6A ✅ 92 / 6B ✅ 90 (зачёт 70→рот.) / задача easy ✅ 93; далее Luhn + 6C) |
