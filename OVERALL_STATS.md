...
| 3 | **AlgoBank** | **Java Core повт. + Spring Boot + Алгоритмы + SQL** | ⏳ В процессе | **4 / 26** (шаги 0-4 завершены, шаг 5 следующий) | **15.9** (старт 11.09.2026, идёт) | **88%** (Ш1: 85, Ш2: 89.6, Ш3: 89.5, Ш4: 89.0; экзамен Ш4: 56/100) | `AlgoBank/COURSE_HANDBOOK.md` |
...
| Пройти AlgoBank | _TBD_ | ⏳ шаг 4/26, следующий — шаг 5 (REST basics) |
...
*Файл создан 28.08.2026 при старте курса №2. Последнее обновление: 17.09.2026 (AlgoBank: шаги 0-4 завершены, 15.9 ч, средний 88%).*
