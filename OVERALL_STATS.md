...
| 3 | **AlgoBank** | **Java Core повт. + Spring Boot + Алгоритмы + SQL** | ⏳ В процессе | **4 / 26** (шаги 0-4 завершены, **шаг 5 почти закрыт: 5A-5C ✅, задачи ✅, артефакты остались**) | **19.7** (старт 11.09.2026, идёт) | **88%** (Ш1: 85, Ш2: 89.6, Ш3: 89.5, Ш4: 89.0; экзамен Ш4: 56/100, ретест 38/60) | `AlgoBank/COURSE_HANDBOOK.md` |
...
| AlgoBank | 11.09.2026 → _TBD_ | 19.7 (в процессе) |
...
- [ ] **Шаг 5 (🔄 в работе: 5A/5B ✅):** Старт проекта + REST basics (`@SpringBootApplication`, `@RestController`)
...
| Пройти AlgoBank | _TBD_ | ⏳ шаг 5/26 в работе (5A/5B ✅, далее 5C) |
...
**Прогресс по шагам:** 25 / 53 (47%) — Spring Core (12) + Spring Boot (9) + AlgoBank (4)

---

*Файл создан 28.08.2026 при старте курса №2. Последнее обновление: 17.09.2026 (AlgoBank: шаги 0-4 завершены, шаг 5 в работе — 5A/5B ✅; ретест шага 4: 38/60). 19.09.2026: шаг 5 — 5C ✅ + задачи FizzBuzz/BankGreeter с первыми JUnit 5 тестами ✅ (90/95), артефакты остались.*
