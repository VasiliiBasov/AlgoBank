...
| 3 | **AlgoBank** | **Java Core повт. + Spring Boot + Алгоритмы + SQL** | ⏳ В процессе | **4 / 26** (шаги 0-4 завершены, **шаг 5 в работе: 5A/5B ✅**) | **17.7** (старт 11.09.2026, идёт) | **88%** (Ш1: 85, Ш2: 89.6, Ш3: 89.5, Ш4: 89.0; экзамен Ш4: 56/100, ретест 38/60) | `AlgoBank/COURSE_HANDBOOK.md` |
...
| AlgoBank | 11.09.2026 → _TBD_ | 17.7 (в процессе) |
