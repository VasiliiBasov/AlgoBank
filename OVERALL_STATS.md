...
| 3 | **AlgoBank** | **Java Core повт. + Spring Boot + Алгоритмы + SQL** | ⏳ В процессе | **5 / 26** (шаги 0-5 завершены, **шаг 6 в работе: 6A ✅ 92/100**, далее 6B ProblemDetail) | **24.7** (старт 11.09.2026, идёт) | **88%** (Ш1-4: 85 / 89.6 / 89.5 / 89.0; Ш5 артефактный: 5C-экзамены 65, задачи 92.5; Ш6A: 92) | `AlgoBank/COURSE_HANDBOOK.md` |
...
| AlgoBank | 11.09.2026 → _TBD_ | 24.7 (в процессе) |
...
| Пройти AlgoBank | _TBD_ | ⏳ шаг 6/26 в работе (шаг 5 ✅ закрыт + тег step-05; 6A ✅, далее 6B) |
