...
*Обновлено 20.09.2026 (вечер): 6B закрыт — самостоятельный ProblemDetail-хэндлер (90/100), прогон `application/problem+json`; зачёт 70/100 (стандарт RFC 9457 как контракт не назван — разобрано). Далее: задачи шага 6 (палиндром IBAN, Luhn) → 6C springdoc. Хвост импорта NotBlank снят учеником ✅.*
